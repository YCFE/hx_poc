...
function webpackBaseConfig(program, kylinApp, option) {
  ...
  }), require('postcss-pxtorem')({root_value: 75, minPixelValue: 3,prop_white_list: [],selectorBlackList:['.mint-', '.picker-', '.mt-', '.mintui']}), program.prod ? _core2.default : null].filter(Boolean);
  ...
  return {
    ...
    plugins: [
      new _htmlWebpackChunkPathRelativePlugin2.default()
    ]
  };
}
